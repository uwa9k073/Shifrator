...
int main() {
  string command,text,pass,s;
  while (command != "."){
    cout << "Введите команду encrypt - чтобы зашифровать, decipher - чтобы расшифровать, stop - чтобы завершить работу программы: " << endl;
    cin >> command;
    if (command=="encrypt"){
    ...
    if (command=="decipher"){
      cout << "Введите пароль для зашифрованого сообщения: " << endl;
      ifstream fin("t2.txt");
